package geektime.spring.data.mybatisgeneratordemo.mapper;
...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Sun Sep 08 18:09:17 CST 2019
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=geektime.spring.data.mybatisgeneratordemo.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("geektime.spring.data.mybatisgeneratordemo.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=geektime.spring.data.mybatisgeneratordemo.handler.MoneyTypeHandler},",
